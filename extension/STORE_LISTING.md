...
**What it detects:**
• Hidden unsubscribe buttons (contrast ratio < 4.5:1, font < 10px)
• Confirm-shaming ("No thanks, I enjoy losing money")
• Pre-ticked marketing checkboxes — illegal under GDPR
• Countdown timers creating artificial urgency
• "Only X left!" fake scarcity messages
• Opt-out links buried in footers
...
## Review tips
- The extension only uses activeTab, scripting, storage, tabs permissions — all standard
- All scanning is client-side / localhost — no remote data collection
- Mention in the "Single purpose" field: "Detects dark UX patterns on web pages"
